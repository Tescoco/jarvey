      ...
      <div className="grid grid-cols-1 gap-4 lg:gap-6 p-4 md:p-5 lg:p-6">
        ...
        <div>
          <div className="mb-3">
            ...
            <p className="text-xs text-gray !leading-normal">
              Define the first response time and / or resolution times to be set
              as goals by your team(s).
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
            <div className="border border-solid border-stroke rounded-xl px-4 py-3">
              <label
                ...
                className="flex items-start gap-2 select-none cursor-pointer mb-3 w-fit"
              >
                <Switch
                  className="mt-1"
                  id="response_time"
                ...
                <span className="flex flex-col gap-y-0.5">
                  <strong className="text-heading font-inter text-sm">
                    First response time
                  </strong>
                  <span className="block max-w-[415px] text-sm text-gray !leading-normal font-normal">
                    The time between the first message from a customer and the
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                ...
                />
                <Dropdown
                  btnClass="!border-0 !bg-[#F7F7F7]"
                  position="bottom"
                  placeholder={response_time[0]}
                  items={response_time}
                />
              </div>
            </div>
        ...
        >
          ...
          <span className="flex flex-col gap-y-0.5">
            ...
            <span className="block text-sm text-gray !leading-normal font-normal">
              When enabled new tickets that fit this criteria will trigger this
              SLA.
            </span>
          </span>
        </label>
