...
export default function ChatSettings() {
  ...
  return (
    <>
      ...
      <MainInner>
        <div className="border-b border-stroke flex overflow-x-auto mb-6">
          {tabBtns.map((item) => (
            <button
              key={item}
        ...
        <div className="flex flex-wrap gap-6">
          ...
          >
            ...
            {(activeTab === "Appearances" ||
              activeTab === "Preferences") && (
                <div className="border-t px-6 py-3 flex justify-end gap-4 mt-6">
          ...
          {(activeTab === "Appearances" ||
            activeTab === "Preferences") && (
              <div className="hidden xl:block w-[350px] h-[calc(100vh-230px)]">
                <div className="chat-btns flex mb-3">
...
//               onClick={() => setActiveTab(item)}
//               key={index}
//               className={`grow font-inter font-medium text-sm px-4 md:px-5 lg:px-6 pb-3 border-b border-solid ${item === activeTab
//                   ? "border-btn text-btn"
//                   : "border-transparent text-heading"
//                 }`}
//             >
...
//           <div
//             className={`flex-none w-full xl:w-[calc(100%-24px-var(--layout-right,350px))] ${activeTab === "Appearances" || activeTab === "Preferences"
//                 ? null
//                 : "!w-full"
//               }`}
//           >
//             <div
//               className={`!pr-0 ${activeTab !== "Languages" &&
//                   activeTab !== "Campaigns" &&
//                   activeTab !== "Installation"
//                   ? c_border
//                   : ""
...
//                       key={index}
//                       onClick={() => setChatTab(item)}
//                       className={`btn hover:scale-100 hover:bg-transparent text-gray hover:!text-gray  px-0 grow ${index === 0 ? "rounded-r-none" : "rounded-l-none"
