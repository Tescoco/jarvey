        ...
        <div className="flex items-start justify-between flex-wrap gap-4 mb-3">
          ...
          <div className="flex-shrink-0 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              />
              <button className="btn flex-shrink-0 text-nowrap min-w-[57px] px-0 bg-green text-white text-sm">
                Test
              </button>
              <button
                className="btn flex-shrink-0 text-nowrap bg-off px-3"
                onClick={handleDiscardChanges}
              >
                Discard Changes
              </button>
              <button
                className="btn flex-shrink-0 text-nowrap bg-primary border-primary text-white min-w-0 px-3"
                onClick={handlePublish}
              >
                Publish
              </button>
              <button className="btn flex-shrink-0 text-nowrap bg-off min-w-0 px-3">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
            ...
            <p className="text-end text-[10px] mt-2.5 whitespace-nowrap">
              Last saved May 20 at 5:13 pm
            </p>
          </div>
        </div>
        <div
          className="flex flex-col rounded-[20px] bg-cover bg-center bg-no-repeat min-h-[600px]"
          style={{ backgroundImage: `url(${bg})` }}
        >
          <div className="flex items-center justify-between gap-4 flex-wrap w-full p-4 md:p-6 pb-0">
            <div className="flex items-center gap-2 flex-shrink-0">
              {editBtn.map((item, index) => (
                <button
                  className="size-10 btn bg-primary border-primary text-white min-w-0 rounded-full p-0 flex items-center justify-center"
                  key={index}
                  onClick={() => {
            ...
            <div className="flex items-center bg-white rounded-lg p-0.5 relative z-10 flex-shrink-0">
              ...
              {activeActionBtn === "analysis" && (
                <div className="absolute top-full right-0 mt-2.5 w-[360px] max-w-[calc(100vw-2rem)] bg-white border border-solid border-stroke rounded-xl shadow-[0px_4px_16px_0px_rgba(0,0,0,0.12)] z-50">
                  <div className="p-3">
                    ...
                    <div className="grid grid-cols-3 gap-6 text-center mt-4">
                      <div>
                        <p className="text-green-700 font-medium text-sm">Automated</p>
                        <p className="mt-2">-</p>
                      </div>
                      <div>
                        <p className="text-[#FE4234] font-medium text-sm">Drop off</p>
                        <p className="mt-2">-</p>
                      </div>
                      <div>
