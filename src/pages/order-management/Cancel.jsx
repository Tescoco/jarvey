      ...
      <div className="flex flex-col gap-4">
        <div className="">
          <p className="mb-2 !leading-normal text-xs font-medium">
            Allow customers to request a cancellation if an order hasn't been
        ...
        <div className="">
          <h3 className="text-sm text-heading font-inter font-semibold !leading-[150%]">
            Eligibility window
          </h3>
          <p>
        ...
        <div className="flex items-center gap-2 md:gap-3 lg:gap-4 ">
          ...
          <Dropdown
            className="!mb-0"
            btnClass="max-h-[48px] min-w-[192px] text-heading font-medium"
            placeholder="Processing Fulfilment"
            isArrow={true}
            items={[
              { name: "Processing Fulfilment" },
              { name: "Unfulfilled " },
          ...
          <button className="cursor-pointer">
            ...
            >
              <path
                d="M11.6663 11.6654L2.33301 2.33203M11.6663 2.33203L2.33301 11.6654"
                stroke="#525866"
                strokeLinecap="round"
              />
            </svg>
