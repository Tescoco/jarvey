...
export default function HomePage() {
  ...
  // Handler for Finish Onboarding button
  const handleFinishOnboarding = () => {
    console.log("Finish Onboarding clicked");
    // Navigate to onboarding page or first incomplete step
    navigate("/onboarding");
    // OR if you want to open in new tab:
    // window.open("/onboarding", "_blank");
  };

  // Handler for sidebar section clicks
        ...
        <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="space-y-4">
                {recommendedSteps.map((step) => (
                  <Link
                    ...
                    className="block"
                  >
                    <div className="group bg-white border border-stroke rounded-xl p-6 hover:shadow-md transition-all duration-300 cursor-pointer">
          ...
          <div className="lg:w-80 space-y-6">
            ...
            <div
              ...
              className="bg-gradient-to-br from-primary to-purple-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 group cursor-pointer"
            >
              <div className="flex items-center justify-between">
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="bg-white text-primary px-5 py-2.5 rounded-lg font-medium text-sm hover:bg-gray-50 active:scale-95 transition-all duration-300 group-hover:scale-105 shadow-sm"
                  >
                    Continue Setup
                  </button>
                </div>
              ...
              {sidebarSections.map((section, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className={`${section.actionColor} text-sm font-medium hover:underline active:scale-95 flex items-center gap-1 group-hover:gap-2 transition-all duration-300`}
                  >
                    {section.actionText}
                    <svg
                      className="w-4 h-4"
