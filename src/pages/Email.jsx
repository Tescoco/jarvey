...
export default function Email() {
  ...
  return (
    <>
      ...
      <MainInner>
        <div className="">
          <p className="text-sm mb-4 md:mb-5 lg:mb-6">
            Connect your support email address and respond to your customers
            from Jarvey
          </p>
          <div className={`${c_24}`}>
            {/* <TableFilter /> */}
                    ...
                    <tr key={index} className="!border-b border-[#E2E4E9]">
                      <td className="md:text-sm text-[#0A0D14] font-medium">
                        <div className="flex items-center gap-2">
                          ...
                          <a
                            href=""
                            className="text-sm font-inter font-medium !text-[#176448] py-1 px-3 rounded-[41px] bg-[#E8EFED] max-w-max"
                          >
                            {item.des}
                          </a>
                        </div>
                      ...
                      <td>
                        <div className=" flex items-center justify-end">
                          <button>
                            ...
                            >
                              <path
                                d="M10.879 10.5004L7.1665 6.78794L8.227 5.72744L13 10.5004L8.227 15.2734L7.1665 14.2129L10.879 10.5004Z"
                                fill="#111111"
                                fillOpacity="0.5"
                              />
                            </svg>
        ...
        {activeData && (
          <div className="">
            ...
            <div className="">
              <h3 className="text-[22px] text-heading font-semibold font-inter !leading-[150%] mb-4">
                Settings
              </h3>
              <div className="flex items-center gap-3 lg:gap-4 mb-4">
                <p className="text-xs md:text-sm text-heading font-semibold !leading-[150%]">
                  Email Address
                </p>
                <a href="" className="text-xs md:text-sm font-medium">
                  examples@gmail.com
                </a>
                <span className="flex items-center gap-1 text-primary text-xs md:text-sm font-medium !leading-[150%]">
                  ...
                  >
                    <g clipPath="url(#clip0_11822_118363)">
                      <path
                        d="M7 0C3.13403 0 0 3.13403 0 7C0 10.8662 3.13403 14 7 14C10.8662 14 14 10.8662 14 7C14 3.13403 10.8662 0 7 0ZM7 13.1388C3.62272 13.1388 0.875 10.3773 0.875 6.99997C0.875 3.62269 3.62272 0.874973 7 0.874973C10.3773 0.874973 13.125 3.6227 13.125 6.99997C13.125 10.3772 10.3773 13.1388 7 13.1388ZM9.79366 4.43866L5.68661 8.5715L3.83708 6.72197C3.66624 6.55113 3.3893 6.55113 3.21824 6.72197C3.04739 6.89281 3.04739 7.16975 3.21824 7.34059L5.38364 9.50622C5.55449 9.67684 5.83142 9.67684 6.00249 9.50622C6.02217 9.48653 6.03903 9.46508 6.05434 9.44278L10.4127 5.05749C10.5833 4.88664 10.5833 4.6097 10.4127 4.43866C10.2417 4.26781 9.96472 4.26781 9.79366 4.43866Z"
                        fill="#7856FF"
                      />
                    </g>
                    <defs>
              ...
              <div className="mb-4">
                ...
                />
                <p>
                  The display name appears on outgoing emails. It cannot
                  contains the following character @.:;{"<>[]"}
                </p>
              </div>
            </div>
            {/* <div className="mb-4">
            ...
            <div className="mb-4">
              {group.map((item, index) => (
                ...
                >
                  ...
                  <div className="">
                    <h3 className="text-sm text-heading font-semibold mb-0.5">
                      {item.titel}
                    </h3>
            ...
            <div className="mb-4">
              ...
              <p className="text-xs font-medium">
                To avoid deliverability issues that can occur when using Gmail's
                API, completeDomain Verification to enable Jarvey AI' email
                delivery platform.
              </p>
            </div>
            <div className="mb-4 md:mb-5 lg:mb-6">
