...
export default function OrderManagement() {
  ...
  const contact = [{ name: "Help" }, { name: "Help-2" }, { name: "Help-3" }];
          ...
          <div className="flex items-start">
            {tabBtns.map((item, index) => (
              <button
                ...
                key={index}
                className={`min-w-[80px] md:min-w-[96px] !text-start font-inter font-medium text-sm px-3 md:px-5 lg:px-6 !border-b-0 ${
                  item === activeTab
                    ? " text-btn"
