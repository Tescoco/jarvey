            ...
            {recommendations.map((item, index) => (
              <div className="grid grid-cols-1 gap-y-3 md:gap-y-4" key={index}>
                {item.items.map((list, i) => (
                  <label
                    key={i}
                    htmlFor={`recommendations_${i + 1}`}
                    className="flex items-center gap-2 mb-0 cursor-pointer pb-3 md:pb-4 last:p-0 border-b last:border-b-0 border-solid border-stroke"
                  >
                    <Checkbox
                      className="mb-0"
                      type="checkbox"
                      id={`recommendations_${i + 1}`}
                    />
