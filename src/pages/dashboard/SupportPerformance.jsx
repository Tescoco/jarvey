                ...
                {agentPerformance.map((item, index) => (
                  <tr key={index}>
                    ...
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.firstResponseTime ? item.firstResponseTime : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.resolutionTime ? item.resolutionTime : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.oneTouchTickets ? item.oneTouchTickets : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.onlineTime ? item.onlineTime : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.messagesSentPerHour
                        ? item.messagesSentPerHour
                        : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.ticketsRepliedPerHour
                        ? item.ticketsRepliedPerHour
                        : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.closedTicketsPerHour
                        ? item.closedTicketsPerHour
                        : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.ticketHandleTime ? item.ticketHandleTime : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.zeroTouchTickets ? item.zeroTouchTickets : "-"}
                    </td>
                  </tr>
                ))}
              </tbody>
          ...
          <div className="overflow-x-auto -mx-6">
            <table className="table">
              ...
              <tbody>
                {hours.map((hour) => (
                  <tr key={hour}>
                    <td className="!text-heading !px-6 !font-medium h-[54px]">
                      {hour}
                    </td>
                    {days.map((day) => {
                      ...
                      return (
                        <td
                          key={day + hour}
                          data-kay={day + hour}
                          className={`h-[54px] !p-0 border-l-2 border-dashed ${
            ...
            <table className="table">
              ...
              <tbody>
                {channelPerformance.map((item, index) => (
                  <tr key={index}>
                    <td className="!text-heading px-6 py-4 !font-bold">
                      {item.Channel ? item.Channel : "-"}
                    </td>
                    <td className="!text-primary px-6 py-4 !font-semibold">
                      {item.CreatedTickets ? item.CreatedTickets : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.OfCreatedTickets}%
                    </td>
                    <td className="!text-primary px-6 py-4 !font-semibold">
                      {item.ClosedTickets ? item.ClosedTickets : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.TicketHandleTime ? item.TicketHandleTime : "-"}
                    </td>
                    ...
                    <td className="!text-primary px-6 py-4 !font-semibold">
                      {item.TicketsReplied ? item.TicketsReplied : "-"}
                    </td>
                    <td className="!text-primary px-6 py-4 !font-semibold">
                      {item.MessagesSent ? item.MessagesSent : "-"}
                    </td>
                    <td className="!text-heading px-6 py-4 !font-semibold">
                      {item.AverageCSAT ? item.AverageCSAT : "-"}
                    </td>
                  </tr>
                ))}
              </tbody>
