...
import InstallTriggers from './InstallTriggers';
...
export default function InstallFlows() {
    ...
    return (
        <>
            <div className={`${c_24}`}>
                <h4 className='text-base md:text-lg font-semibold !leading-normal mb-4 md:mb-5'>Installed Flows</h4>
                <Input className='mb-4 md:mb-5' type="text" placeholder="Search..." leftIcon={search} inputClass='!h-[36px]' />
                <div className="overflow-auto">
                    <table className='w-full table'>
                        <thead>
                            <tr className="bg-[#F6F8FA]">
                                {["Flow", "Language", "Flow", "Actions",].map((item, index) => (
                        ...
                        <tbody>
                            {flowTable.map((item, index) => (
                                <tr key={index} className='!border-b border-[#E2E4E9]'>
                                    <td className='md:text-sm text-[#0A0D14] font-medium'>{item.name}</td>
                                    <td>
                                        <img src={item.img} alt="" />
                                    </td>
                                    <td className='text-[#0A0D14] md:text-sm font-medium'>{item.date} </td>
                                    <td>
                                        <div className=" flex items-center justify-end gap-2 ">
                                            <button>
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M2.33317 8.89714H8.1665C8.56921 8.89714 8.89567 8.57068 8.89567 8.16797V2.33464C8.89567 1.93193 8.56921 1.60547 8.1665 1.60547H2.33317C1.93046 1.60547 1.604 1.93193 1.604 2.33464V8.16797C1.604 8.57068 1.93046 8.89714 2.33317 8.89714Z" fill="#7856FF" />
                                                    <path d="M5.104 8.89714V11.668C5.104 12.0707 5.43046 12.3971 5.83317 12.3971H11.6665C12.0692 12.3971 12.3957 12.0707 12.3957 11.668V5.83464C12.3957 5.43193 12.0692 5.10547 11.6665 5.10547H8.89567M8.1665 8.89714H2.33317C1.93046 8.89714 1.604 8.57068 1.604 8.16797V2.33464C1.604 1.93193 1.93046 1.60547 2.33317 1.60547H8.1665C8.56921 1.60547 8.89567 1.93193 8.89567 2.33464V8.16797C8.89567 8.57068 8.56921 8.89714 8.1665 8.89714Z" stroke="#7856FF" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" />
                                                </svg>
                                            </button>
                                            <button>
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h4 className='text-base md:text-lg font-semibold !leading-normal my-4 md:m-y5'>Add New From Template</h4>
            <InstallTriggers />
        </>
    )
}
