        ...
        {CardItems.map((item, idx) => (
          ...
          >
            ...
            <button
              ...
              className="w-full rounded-lg p-2 shadow-[0px_1px_2px_0px_rgba(90,54,191,0.48),_0px_0px_0px_1px_#6E3FF3] border-[#7856FF] text-[#7856FF] text-xs font-semibold leading-[1.66] hover:bg-[#7856FF] hover:!text-white mt-auto"
            >
              View
            </button>
          </div>
