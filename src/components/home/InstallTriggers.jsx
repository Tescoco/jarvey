          ...
          <table className="w-full table-fixed min-w-[600px]">
            <thead>
              <tr className="bg-[#F6F8FA]">
                <th className="text-left text-sm text-[#525866] !font-normal py-2 px-3 w-[50%]">
                  Trigger
                </th>
                <th className="text-left text-sm text-[#525866] !font-normal py-2 px-3 w-[20%]">
                  Date
                </th>
                <th className="text-right text-sm text-[#525866] !font-normal py-2 px-3 w-[30%]">
                  Actions
                </th>
              </tr>
            </thead>
            <tbody>
              {filtered.map((row, idx) => (
                <tr
                  key={idx}
                  className={`border-b border-[#E2E4E9] transition-all ${isDragging ? "cursor-grabbing" : "cursor-grab"
                    } hover:bg-gray-50`}
                  draggable
                ...
                >
                  <td className="py-2 px-3">
                    <div className="flex items-center gap-2">
                      <button className="flex-shrink-0 cursor-move p-1 hover:bg-gray-200 rounded transition-colors">
                        <svg
                          width="8"
                          height="14"
                          viewBox="0 0 8 14"
                      ...
                      <span className="text-sm text-[#0A0D14] font-medium truncate">
                        {row.title}
                      </span>
                    </div>
                  </td>
                  <td className="py-2 px-3 text-sm text-[#0A0D14] font-medium">
                    {row.date}
                  </td>
                  <td className="py-2 px-3">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="btn bg-off !px-2 !py-1 text-xs whitespace-nowrap"
                      >
                        Edit
                      </button>
                      <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:gap-4">
        {CardItems.map((item, idx) => (
          <button
            ...
            className="text-left group border border-[#E2E4E9] rounded-lg lg:rounded-xl xl:rounded-2xl p-3 lg:p-4 cursor-pointer hover:border-[#7856FF] transition-colors"
            key={idx}
          >
            ...
            <div className="flex items-center gap-2 lg:gap-[10px] mb-2 flex-wrap">
              {item.tag.map((tag, i) => (
                <Alert
                  key={i}
                  text={tag.text}
