        ...
        <div className="bg-[#F7F7F7] rounded-lg lg:rounded-xl xl:rounded-2xl mb-3 lg:mb-4">
          <div className="md:flex items-center justify-between py-2 px-4">
            <div className="mb-2 lg:mb-0">
              <button className="!bg-white text-[#0A0D14] text-xs font-medium !leading-[1.5] py-2 lg:py-[9px] px-6 lg:px-7 rounded-xl ">
                Mail
              </button>
              <button className="text-[#0A0D14] text-xs font-medium !leading-[1.5] py-2 lg:py-[9px] px-6 lg:px-7">
                Message
              </button>
            </div>
            <Dropdown
          ...
          <div className="px-3 lg:px-4">
            <p className="text-[#0A0D14] text-sm font-medium !leading-[1.4] tracking-[-0.084px] border-y border-y-[#E2E4E9] py-2 lg:py-3">
              Subject:{" "}
              <span className="text-xs text-gray font-normal !leading-[1.66]">
                Type here
              </span>
            </p>
            <div className="py-3 lg:py-4">
              <textarea
                className="text-gray text-xs font-medium !leading-[1.66] mb-1 bg-transparent w-full resize-none placeholder:text-gray h-16 overflow-y-auto"
                placeholder="Enter your questions"
              />
              <p className="text-heading text-sm font-medium !leading-[1.42] mb-2">
                or test a common question
              </p>
              <div className="flex items-center flex-wrap gap-3 mb-3">
                {autoAnswer.map((item, index) => (
                  <button
                    key={index}
                    className="block font-medium font-inter text-sm bg-white rounded-lg px-3 py-2 text-heading w-fit"
                  >
                    {item}
                  </button>
                ))}
