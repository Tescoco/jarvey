          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                className="flex-1 bg-purple-600 text-white rounded-lg py-2 font-medium hover:opacity-90"
              >
                Add
              </button>
              <button
          ...
          <div className="bg-white rounded-xl p-6 w-full max-w-md mx-4">
            ...
            <div className="flex gap-3 mt-6">
              <button
                ...
                className="flex-1 bg-[#7856FF] text-white rounded-lg py-2 font-medium hover:opacity-90"
              >
                Add
              </button>
              <button
