          ...
          <div className="text">
            <div className="text mb-5">
              ...
              <p className="text-xs text-[#858585] font-inter font-medium !leading-[120%]">
                Change navigation elements at the top of the help center.
              </p>
            </div>
            <div className="mb-4 relative z-[1]">
              ...
              <p className="text-xs text-[#858585] font-inter font-medium !leading-[120%] mt-1">
                Redirect your logo to a custom URL.
              </p>
            </div>
            <label
              htmlFor="policy"
            ...
            <div className="">
              <h2 className="text-lg text-black font-inter font-semibold !leading-[130%] mb-2">
                Navigation Links
              </h2>
          ...
          <div className="text">
            ...
            <div className="mb-4">
              ...
              >
                <Switch id="policy3" />
                <p className="font-inter font-medium text-sm text-heading">
                  Powered by Jarvey AI
                </p>
              </label>
              <p className="text-xs text-[#858585] font-inter font-medium !leading-[120%] -mt-4 pl-0 md:pl-6 lg:pl-8 xl:pl-12">
                Use this toggle to display or hide the Jarvey AI branding on the
                footer in Help Center.
              </p>
            </div>
            <div className="">
              <h2 className="text-lg text-black font-inter font-semibold !leading-[130%] mb-2">
