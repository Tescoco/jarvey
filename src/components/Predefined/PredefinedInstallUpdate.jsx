...
import AddActions, { ActionsProvider, ActionsRenderer } from "../AddActions";
import AddShopifyActions, {
  ShopifyActionsProvider,
  ShopifyActionsRenderer,
} from "../AddShopifyActions";
      ...
      <ShopifyActionsProvider>
        <div>
          ...
          <div className="p-4 lg:p-5 xl:p-6">
            <h6 className="md:mb-0 text-lg lg:text-xl xl:text-2xl text-[#0A0D14] font-semibold !leading-[1.5] mb-5 lg:mb-6">
            ...
            <div className="mt-5 lg:mt-6">
              ...
              {/* Render Actions inline with no border */}
              <ActionsRenderer />

              {/* Render Shopify Actions inline with no border */}
              <ShopifyActionsRenderer />
              ...
              <div className="flex items-center justify-end gap-3 lg:gap-4 mt-5 lg:mt-6">
                ...
                >
                  Duplicate Predefined Response
                </Link>
                <Link
                  to="#"
                  className="btn !bg-[#8667FF] !text-white hover:!text-white"
                >
