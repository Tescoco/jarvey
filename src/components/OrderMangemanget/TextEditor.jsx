...
export default function TextEditor({ value = "okay", onChange, onClick }) {
  const textEditor = [
    {
      icon: (
        <svg
  ...
  return (
    <div className="p-4 pt-3 bg-primary/5 border border-stroke rounded-xl min-h-[380px] flex flex-col justify-between">
      <textarea
        name=""
        id=""
        className="bg-transparent min-h-[232px] resize-none"
        value={value}
      ...
      <div className="">
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <button
            onClick={onClick}
            className="btn !min-w-[115px] !px-0 !bg-primary !text-white"
          >
            Save Changs
          </button>
        </div>
